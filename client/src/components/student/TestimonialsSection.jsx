    ...
    return (
        <div className='pb-14 md:px-0 px-8'>
            ...
            <p className='md:text-base text-gray-500 mt-3'>
                Hear from our learners as they share their journey of transformation, success, and how our <br/> platform has made a difference
                in their lives.
            </p>
            ...
            <div className='grid grid-cols-auto gap-8 mt-14'>
                {dummyTestimonial.map((testimonial, index)=>(
                    <div key={index} 
                        ...
                        <a href="#" className='text-blue-500 underline px-5'></a>
                    </div>
                ))}
            </div>
        </div>
